...
<body>
    ...
    <form action="addUserInfo.do" method="post">
        <table border="0" width="500px" cellpadding="0" cellspacing="0" style="margin-left: 100px">
            <tr>
                <td align="left" colspan="2">
                    <h2>Add Information Insurance Card</h2>
                </td>
            </tr>
            ...
            <tr>
                ...
                <td align="left" height="30"><input name="radioValue" type="radio" value="1"
                    ...
                    <div id="one" class="CF" style="display:${radioDisplay==1 ? 'block' : 'none'};">
                        <select style="margin: 10px" name="companyInternalId" id="selectClass">
                                ...
                                <c:choose>
                                    <c:when test="${company.companyInternalId == companyInternalId}">
                                        <tr>
                                            <td>Company Name</td>
                                            <td><input type="text"
                                                value="<c:out value="${company.companyName}" escapeXml="true"/>"
                                                size="25" /></td>
                                        </tr>
                                        <tr>
                                            <td>Email</td>
            ...
            <tr>
                ...
                <td align="left"><input type="text" id="datepicker_insuranceStartDate" name="insuranceStartDate"
        ...
        <c:set var="url" value="showDetailUser.do?id=" />
        <div style="padding-left: 45px;">
            <table border="0" cellpadding="4" cellspacing="0">
                <tr>
                    <td><input type="button" value="Back" onclick="location.href='listuser.do?typeAction=back'" /></td>
...
<script>
    ...
    function selectAjax(value) {
        $.ajax({
            url : "addUserInfo.do?typeAction=ajax",
            type : 'GET',
            dataType : 'html',
            data : {
